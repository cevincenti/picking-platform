...
namespace PickingWSApi.Application.UseCase.V1.PersonOperation.Commands.Create
{
    public record struct CreatePersonCommand : IRequest<Response<CreatePersonResponse>>
    {
        /// <summary>
        /// 
        /// </summary>
